...
const char* ssid = "AQUI TU WIFI";
const char* password = "AQUI TU PASSWORD";
...
#define ARGENTINA -14400   // Número de segundos de zona horaria Argentina (UTC-04:00)
#define GUATEMALA -21600   // Número de segundos de zona horaria Guatemala City (UTC-06:00)
#define DST 0
